...
import '../models/domain_firms.dart';
import '../providers/domainfirms_provider.dart';
    ...
    return Scaffold(
      appBar: AppBar(
          title: (widget.domainfirm != null)
              ? const Text('Edit Domain Firm')
              : const Text('Add Domain Firm')),
      body: Padding(
        ...
        child: ListView(
          children: <Widget>[
            TextField(
              ...
              decoration: const InputDecoration(hintText: 'Domain Firm Name'),
              onChanged: (value) {
            ...
            TextField(
              ...
              decoration: const InputDecoration(hintText: 'Domain Firm Login Name'),
              onChanged: (value) {
